          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-[#e69138] dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                ...
                <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  What truly sets us apart is our knowledge of the problems our
                  customers face in creating video content and our knowledge of
                  the technology and resources that can help them and how we
